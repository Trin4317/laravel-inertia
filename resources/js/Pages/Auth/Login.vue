<template>
    ...
    <main class="grid place-items-center min-h-screen">
        <section class="bg-white p-8 rounded-xl border max-w-md mx-auto mt-8">
            ...
            <form @submit.prevent="submit">
                <div class="mb-6">
                    ...
                    <input v-model="form.email" class="border rounded p-2 w-full" type="email" name="email" id="email" required>
                ...
                <div class="mb-6">
                    ...
                    <input v-model="form.password" class="border rounded p-2 w-full" type="password" name="password" id="password" required>
